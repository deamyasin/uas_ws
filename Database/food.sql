...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2021 at 01:53 PM
...
CREATE TABLE `app_pages` (
  ...
  `page_content_en` longtext NOT NULL,
  `page_title_ar` varchar(255) NOT NULL,
  `page_content_ar` longtext NOT NULL,
  `created_at` datetime NOT NULL,
...
CREATE TABLE `delivery_boy` (
  ...
  `boy_phone` varchar(30) NOT NULL,
  `boy_password` varchar(255) NOT NULL,
  `boy_email` varchar(255) NOT NULL,
  `boy_id_proof` varchar(255) NOT NULL,
  `boy_licence` varchar(255) NOT NULL,
  `id_photo` varchar(255) NOT NULL,
  `licence_photo` varchar(255) NOT NULL,
  `vehicle_no` varchar(255) NOT NULL,
  `boy_photo` varchar(255) NOT NULL,
...
CREATE TABLE `email_templates` (
  ...
  `email_subject_en` longtext NOT NULL,
  `email_message_en` longtext NOT NULL,
  `email_subject_ar` longtext NOT NULL,
  `email_message_ar` longtext NOT NULL,
...
INSERT INTO `logs` (`log_id`, `data_table`, `data_action`, `log`, `user_id`, `created_at`, `ip`, `tablepkid`) VALUES
(1, 'users', 'update', '', 1, '2021-04-08 03:07:50', '::1', 1);
...
(0, 'env_token', '4f613328ff02e1b0ac5fce28400013d8eb9ce71d99e4c1c98e6dadbc340ef4e1659e0f684d3e3d80107f139f914015930era0615oUxduHtDXC3P6W0hMtcC03ioO8LN1WtJzRo9BXFCHDzyU2LvhiUQPhwaFUqKmauOZBd0Xx09wg9880Og--', 'token', 1),
(1, 'name', 'Projekita App', 'general_setting', 1),
(2, 'copyright', 'Projekita', 'general_setting', 1),
(3, 'website', 'https://projekita.com', 'general_setting', 1),
(4, 'currency', 'IDR', 'general_setting', 1),
(5, 'currency_symbol', 'Rp', 'general_setting', 1),
...
(17, 'mobile_prefix', '+62', 'general_setting', 1),
...
(55, 'date_default_timezone', 'Asia/Jakarta', 'general_setting', 1);
...
(1, 1, 'projekita@projekita.com', 'e10adc3949ba59abbe56e057f20f883e', 'Projekita', '.com', '1111111111', 'ed9d000b7f21720f449a69b6922dabbd_DS LOGO 2.jpg', 'wayweb', 'W0001', '', '', 0, 0, '4ab8f3960ea51263b6daf54555cbda44', 1, 0, '0000-00-00 00:00:00', '2021-04-08 03:07:50', 0, 1, 0),
