package com.foodorder.ui.profile.dialog
...
class BottomSheetEditProfileDialog : BottomSheetDialogFragment {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.bottom_sheet_edit_profile, container, false)
        ...
        } else if (title.equals(contexts.resources.getString(R.string.email_address))) {
            rootView.et_edit_profile_value.filters = arrayOf<InputFilter>(
                TextInputFilter(
                    TextInputFilter.Filter.ALLOW_EMAIL_ONLY
                ), InputFilter.LengthFilter(50)
            )
        } else if (title.equals(contexts.resources.getString(R.string.phone_number))) {
            rootView.et_edit_profile_value.filters = arrayOf<InputFilter>(
                TextInputFilter(
