package com.foodorder.ui.menu_item.adapter
...
class MenuItemAdapter(
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val tv_menu_name: TextView = view.tv_menu_item_menu_name
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.tv_menu_name.text = CommonActivity.getStringByLanguage(
            context,
            mList.cat_name_en,
            mList.cat_name_ar
        )
